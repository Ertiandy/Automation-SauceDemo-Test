...
import api.request.RequestAPIUserManagement;
...
public class ApiTestUser {
    ...
    public void checkResponseBodyCreateUser(UserProfile dataTestUser) throws ParseException {
        ...
        String expectedDate = sdfDate.format(new Date());
    ...
    public void checkResponseBodyUpdateProfileUser(UserProfile dataTestUser, String idUserUpdate) throws ParseException {
        ...
        Assert.assertEquals(expectedDate, sdfDate.format(sdfTime.parse(actualData.getRegisterDate())));
        Assert.assertEquals(expectedDate, sdfDate.format(sdfTime.parse(actualData.getUpdatedDate())));
